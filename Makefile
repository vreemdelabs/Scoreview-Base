...
ifdef RELEASE
FLAGS = -Wall -O2 -c -D$(OPERATINGON) $(SDL2_FLAGS) -I$(INCLUDES) $(OPENCL_INCLUDES) -I$(MESHINCLUDES) -I$(COMMONINCLUDES) -I$(MESSAGESINCLUDES) -I$(PORTAUDIOUTILSINCLUDES)
else
FLAGS = -Wall -g  $(CHECKSTACK) -c -D_DEBUG -D$(OPERATINGON) $(SDL2_FLAGS) -I$(INCLUDES) $(OPENCL_INCLUDES) -I$(MESHINCLUDES) -I$(COMMONINCLUDES) -I$(MESSAGESINCLUDES) -I$(PORTAUDIOUTILSINCLUDES)
endif
